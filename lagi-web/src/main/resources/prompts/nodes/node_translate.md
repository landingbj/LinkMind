...
| data.inputs                      | object | 是  | 输入的属性定义,该节点为固定的结构，不可修改, object : { "type": "object", "required": ["text", "targetLanguage"], "properties": { "text": { "type": "string", "description": "要翻译的文本" }, "targetLanguage": { "type": "string", "description": "目标语言（en/english/zh/chinese）" } } }  |
...
| data.outputs                     | object | 是  | 输出属性的定义,该节点为固定的结构，不可修改, object   { "type": "object", "properties": { "result": { "type": "string", "description": "翻译后的文本" }, "sourceText": { "type": "string", "description": "源文本" } }, "required": ["result", "sourceText"] } }                            |
